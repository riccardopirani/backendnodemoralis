  ...
  try {
    ...
    const nftFunctions = [
      ...
      },
      {
        name: "balanceOf",
        selector: "0x70a08231",
        params: ["0x12Ae466d0f74d152aA352DC8029c631683Bf607b"],
      },
      {
        name: "tokenURI",
        selector: "0xc87b56dd",
      ...
      },
      {
        ...
        selector: "0xe985e9c5",
        params: [
          "0x12Ae466d0f74d152aA352DC8029c631683Bf607b",
          "0x12Ae466d0f74d152aA352DC8029c631683Bf607b",
        ],
      },
      {
      ...
      try {
        ...
        if (func.name === "balanceOf") {
          ...
          data =
            ...
            func.params[0].slice(2) +
            "000000000000000000000000" +
            func.params[1].slice(2);
        } else if (
          func.name === "ownerOf" ||
          func.name === "tokenURI" ||
          func.name === "getApproved" ||
          func.name === "userIdHash"
        ) {
        ...
        if (result && result !== "0x") {
          ...
          console.log(
            `❌ ${func.name}(): Non supportata o token non esistente`,
          );
        }
      } catch (error) {
        if (error.message.includes("ERC721NonexistentToken")) {
          console.log(
            `⚠️  ${func.name}(): Token non esistente (normale per tokenId 1)`,
          );
        } else {
    ...
    const fs = require("fs");
    fs.writeFileSync(
      "contract_full_ABI.json",
      JSON.stringify(fullABI, null, 2),
    );
